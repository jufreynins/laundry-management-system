    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.settings.update', $location) }}">
            ...
            <div class="mb-3 form-check">
                <input type="checkbox" name="sales_tax_enabled" value="1" class="form-check-input" id="sales_tax_enabled" {{ $settings['sales_tax_enabled'] === '1' ? 'checked' : '' }}>
                <label class="form-check-label" for="sales_tax_enabled">Sales Tax Enabled</label>
            </div>
            <div class="mb-3">
